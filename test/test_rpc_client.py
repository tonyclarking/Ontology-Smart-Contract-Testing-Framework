...
class TestRpcClient(unittest.TestCase):
    ...
    def test_get_block_by_hash(self):
        ...
        block = sdk.rpc.get_block_by_height(1000)
        print("block info is ", block)
        txhash = "0dad6975bf1ab0f8ca9e9ea749643b539a5b5ee155b6bad371c5b5ef2278bbdf"

        res = sdk.rpc.get_smart_contract_event_by_tx_hash(txhash)
        print("smart contract event is ", res)

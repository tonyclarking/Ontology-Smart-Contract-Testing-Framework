    ...
    public class SwapContract : SmartContract
    {
        ...
        public static Object Main(string operation, params object[] args)
        {
            if (operation == "Swap")
            {
                ...
                return Swap(from, to, fromSymbol, toSymbol, value);
            }

            
            // 设置积分兑换比率，比如1全家:2有叻,symbol=quanjia, base=1,symbol=youle,base=2
        ...
        // fromSymbol是发起方token的符号，比如老庙积分,"laomiao", toSymbol同理
        // value 是兑换token的数量
        public static bool Swap(byte[] from, byte[] to, string fromSymbol, string toSymbol, ulong value)
        {
